...
for(iter in seq(1,1000)){
  ...
  for(i in 1:n3){
    # Generate cluster membership
    c_d_rwd[i] <- sample(c(1,2), 1, replace = T, prob = norm_weight_RWD)
    # Generate covariates
    if(c_d_rwd[i] == 1){
  ...
  #saveRDS(list(d_mat = d_mat, c_mat = c_mat), file = paste0("./Sim_data/Sc3_Data_e1/Covariates_sim_sc3_",iter+1,".RData"))
  saveRDS(list(d_mat = d_mat, c_mat = c_mat), file = paste0("./Sc3_",n_RCT,"/Covariates_sim_sc3_",iter,".RData"))
  ...
  saveRDS(y_out_0, file = paste0("./Sc3_",n_RCT,"/Outcome_sim_sc3_",iter,"_0.RData"))
  
  y_out_1 <- gen_out(n1, n2, n3, n1_actual, n2_actual, 1, cov_d, T_d)
  saveRDS(y_out_1, file = paste0("./Sc3_",n_RCT,"/Outcome_sim_sc3_",iter,"_1.RData"))
  
  y_out_2 <- gen_out(n1, n2, n3, n1_actual, n2_actual, 2, cov_d, T_d)
  saveRDS(y_out_2, file = paste0("./Sc3_",n_RCT,"/Outcome_sim_sc3_",iter,"_2.RData"))
  
  y_out_3 <- gen_out(n1, n2, n3, n1_actual, n2_actual, 3, cov_d, T_d)
  saveRDS(y_out_3, file = paste0("./Sc3_",n_RCT,"/Outcome_sim_sc3_",iter,"_3.RData"))
  
  
  #y_out <- gen_out(n1, n2, n3, n1_actual, n2_actual, 1, cov_d, T_d)
  #saveRDS(y_out, file = paste0("./Sim_data/Sc3_Data_e1/Outcome_sim_sc3_",iter+1,"_1.RData"))
  
  #y_out <- gen_out(n1, n2, n3, n1_actual, n2_actual, 3, cov_d, T_d)
  #saveRDS(y_out, file = paste0("./Sim_data/Sc3_Data2/Outcome_sim_sc3_",iter+1,".RData"))
  
  #y_out_null <- gen_out(n1, n2, n3, n1_actual, n2_actual, 2, cov_d, T_d)
  #saveRDS(y_out_null, file = paste0("./Sim_data/Sc3_Data_e1/Outcome_sim_sc3_",iter+1,"_2.RData"))
  
  #y_out_null <- gen_out(n1, n2, n3, n1_actual, n2_actual, 0, cov_d, T_d)
  #saveRDS(y_out_null, file = paste0("./Sim_data/Sc3_Data2/Outcome_sim_sc3_",iter+1,"_null.RData"))
}